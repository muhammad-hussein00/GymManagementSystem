        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhone", "Phone LIKE '01%' AND Phone LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_On_DurationDays", "[DurationDays] > 0 AND [DurationDays] <= 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhone1", "Phone LIKE '01%' AND Phone LIKE '%[^0-9]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberPlans", x => new { x.MemberId, x.PlanId, x.StartDate });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_On_Capacity", "Capacity between 1 and 25");
                    table.CheckConstraint("CK_On_Date", "EndDate > StartDate ");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => new { x.MemberId, x.SessionId, x.BookingDate });
                    table.ForeignKey(
